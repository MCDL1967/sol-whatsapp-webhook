...
1. `Schema_Proposal_v0.3.html`
   - Main schema review portal.
   - Use this file to mark schema sections, tables, fields, hardcode replacements, and decisions as reviewed.
...
3. `docs/db_planning/README.md`
   ...
   - Use this as the entry point for deeper review of runtime config, menu runtime service, demo data mapping, voice scope, hardcode retirement, and schema/tool gaps.

## How to Review `Schema_Proposal_v0.3.html`

1. Open `Schema_Proposal_v0.3.html` in your browser.
...
```text
SOL_Schema_Proposal_v0.3_feedback.json
```
...
1. Collect each collaborator's exported `SOL_Schema_Proposal_v0.3_feedback.json`.
2. Open `Schema_Proposal_v0.3.html` locally.
...
1. Exported schema feedback JSON from `Schema_Proposal_v0.3.html`.
