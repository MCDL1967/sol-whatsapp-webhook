...
## v0.3 Accepted Runtime Package Contract

The runtime package should compile deterministic execution data from normalized DB configuration. It should include:
...
- venue labels, aliases, visibility, descriptions, and approved hours
- reservation rules
- team routing map
...
Voiceflow initialization variables should be derived from the approved DB/config variables in this contract and the canonical schema.

The normalized DB remains the source of truth. The package is the live-turn read model.
